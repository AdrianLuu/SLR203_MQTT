...
//added external jar: E:\PahoMQTT\Lib\org.eclipse.paho.client.mqttv3-1.2.5.jar
...
public class PublishingMqttClient {//synchronous client
	...
	public static void main(String[] args) {
	    ...
	    String messageContent = "Time: " + LocalDateTime.now().toString() + "\n" + "Message 2 from my Lab's Paho Mqtt Client";
	    int qos             = 0; 
